...
namespace details {
void reduct_element(Matrix<long double>& A, size_t i, size_t b,
...
void band_reduction(Matrix<long double>& A, size_t band_width,
                    const long double eps = convolution_svd::constants::DEFAULT_EPSILON) {
...
void block_band_upper(Matrix<long double>& A, size_t band_width, size_t block_height, size_t block_width,
                      const long double eps = convolution_svd::constants::DEFAULT_EPSILON) {
